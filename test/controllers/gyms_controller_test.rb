...
class GymsControllerTest < ActionController::TestCase
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post :create, gym: { latitude: @gym.latitude, longitude: @gym.longitude, name: @gym.name, user_id: @gym.user_id }
    end
  ...
  test "should update gym" do
    patch :update, id: @gym, gym: { latitude: @gym.latitude, longitude: @gym.longitude, name: @gym.name, user_id: @gym.user_id }
    assert_redirected_to gym_path(assigns(:gym))
  end
